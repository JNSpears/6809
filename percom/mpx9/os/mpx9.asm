...
;JNS-   
 ...
 IFDEF CURDRIVE
        LDA #1
        STA CURDRV,PCR          ; SET INITIAL DEFAULT DRIVE TO 1
 ENDC
        LBRA MPXRET 
 SPC 1
MPXBAN FCB CR,LF
...
DSKCMD LBSR SETFCB INITIALIZE FCB
 ...
 STD FCBSUF,Y
DSKCM1 LBSR LOCFL LOOK UP THE FILE
...
INFCB1 CLR ,Y+ CLEAR THE FCB TO ZEROES
 ...
 IFDEF CURDRIVE
  LDA CURDRV,PCR SET DEFAULT DRIVE TO CURRENT DRIVE
 ELSE
...
CURRENT:
 LBSR GETDRV GET THE DRIVE #
 STA CURDRV,PCR SAVE CURRENT DRIVE
 CLRB
 RTS
 SPC 1
 ENDC
