...
ENCL8 LDB N     ; save NC
 LBRA PUSHD
*
 WORDM 5,'CMOVE' ; ( FROM-3, TO-2, QUAN-1 ... )
CMOVE FDB *+2
 BSR PCMOVE
 LBRA NEXT
...
*
 WORDM 2,'GO'
GO FDB DOCOL
 FDB MTBUF,MNTSCR,NOOP,NOOP,NOOP,NOOP,NOOP ; JNS -- filler to allow patches later.
 FDB DOCMDARG
 FDB LIT,XMSGBS,AT,THREE,PLUS,DRZERO,LOAD 
 FDB SEMIS
*
RAM FCB $C5
 FCC "FORT"
...
DUMP1 FDB CR,HEX,I,ZERO,LIT,4,DDOTR,I,CLITER
 FCB 16
 FDB PLUS,I,XDO
